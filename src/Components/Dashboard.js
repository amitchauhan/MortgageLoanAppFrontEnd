...
const Dashboard = () => {
    return (
        ...
        <div >
             {/* code for jumbotron */}
        <div className="jumbotron" style={{backgroundColor:"lightcoral", color:"white", marginBottom:0}}>
  ...
  <h2>Your application is at <b><u>Underwriting</u></b> stage currently and one of our representatives will contact you shortly..</h2>
  <br/>
  <h2><b>Please note:</b> We will run credit check only after your application is approved by mortgage adviser and indication of mortgage payments has been provided to you.</h2>
  </div>
</div>
{/* jumbotron ends here */}
             {/* code for jumbotron */}
...
{/* jumbotron ends here */}
    <div className='container'>
        ...
        <div className='row' >
            ...
            <h5>Once you have applied for a mortgage, we will usually arrange for a mortgage valuation for our purposes so that we know that the property you are purchasing or remortgaging will be enough security for the loan you're applying for.</h5>
            </div>
        </div>
        {/* code for offer */}
        <br/>
