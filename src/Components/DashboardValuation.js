...
const DashboardValuation = () => {
    return (
        ...
        <div >
             {/* code for jumbotron */}
        <div className="jumbotron" style={{backgroundColor:"lightseagreen", color:"white", marginBottom:0}}>
  ...
  <h2>Your application is at <b><u>Valuation</u></b> stage currently. <br/>
  Your application will move to offer stage once valuation report is received from valuer and assessed by the valuation team. You will be notified via email once your application is moved to next stage.</h2>
</div>
{/* jumbotron ends here */}
             {/* code for jumbotron */}
