...
const DashboardOffer = () => {
    return (
        ...
        <div >
             {/* code for jumbotron */}
        <div className="jumbotron" style={{backgroundColor: "darkkhaki", color:"white", marginBottom:0}}>
  ...
  <h2>Your application is at <b><u>Offer</u></b> stage currently. You will receive offer letter in two working days time which you need to sign and accept. <br/>
  Please ignore if done already.</h2>
</div>
{/* jumbotron ends here */}
             {/* code for jumbotron */}
